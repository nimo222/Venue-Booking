...
<body>
	...
	<div class="container-login100" style="background-image: url('images/url.png');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-40 p-b-30">
			...
			<div class="container-login100-form-btn mb-4">
					<div class="row mr-5">
						<div class="col-6">
                        <a href="http://localhost/VenueBooking/login.php"><button type="button" class="login100-form-btn" name="user" >User</button></a>
						</div>
						<div class="col-6">
                            <a href="http://localhost/VenueBooking/admin_login.php"><button type="button" class="login100-form-btn active" name="admin" >Admin</button></a>
						</div>
					</div>
				</div>
				...
				<div class="text-center ">
					<a href="http://localhost/VenueBooking/reg.php" class="txt2 hov1">
						Sign Up
					</a>
				</div>
			</form>
...
if(isset($_REQUEST['sign'])) {
 ...
 foreach($rows as $row){
	...
	echo "<script>document.location.href='http://localhost/VenueBooking/admin_home.php?ad_mail=".$email."';</script>";
       
    }

 }
 echo "<script>if(confirm('Invalid credentials. Check Again')){document.location.href='http://localhost/VenueBooking/admin_login.php'};</script>";
}
?>